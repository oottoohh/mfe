$(document).ready(function () {
    ...
    var branchProfileID = GetParameterByName('QuestionTest');
    ...
    if (QuestionAnswerCode == '') {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                viewModel.set('SubTestCd', data.SubTestCode);
                ...
                viewModels.set("SubTestCode", data.SubTestCode);
                TestToolByTestType();
                AnswerLayout();
                if (data.QuestionCategory == 'NORMAL') {
                    ...
                    if (data.AnswerTypeCode == "AT19000001") {
                        ...
                        for (nt = 0; nt < data.Answers.length; nt++) {
                            ...
                            if (nt >= 3) {
                                //alert(nt);
                                $('#addForm').append('<div class="addFormAnswer" id="labels' + nt + '">' +
                                    '<label>Answer ' + no + '<span class="mandatory">*</span></label>' +
                                    '<a href="#" no="' + nt + '" id="noms' + nt + '" style="padding-left:65%;" hidden="hidden"><i class="fas fa-trash-alt"></i></a>' +
                            ...
                            if (ilk >= 3) {
                                $('#add_image').append('<div class="add_image" id="label' + ilk + '">' +
                                    ...
                                    '<label style="padding-left:140px;padding-right:120px;">' +
                                        ...
                                        '<img id="mediaDisplay' + no + '" src="" style="background: no-repeat url(../../../Images/add-picture.jpg) center; border: thin" width="220" height="145" />' +
                                ...
                                $('#btnAnswerImage').attr('nomor', (check) - 1);
                            }
                            no++;
                    ...
                    for (i = 0; i < data.Answers.length; i++) {
                        ...
                        if (i >= 3) {
                            $('#answer_working_page').append('<div class="answer_working_page" id="labels' + i + '">' +
                                '<label>Answer ' + no + '</label>' +
                                '<a href="#" no="' + i + '" id="noms' + i + '" style="padding-left:65%;" hidden="hidden"><i class="fas fa-trash-alt"></i></a>' +
                                '<div style="padding-left:140px;padding-right:120px;">' +
                    ...
                    AnswerMemoryAttr(checkLength, idAttr);
                    for (j = 0; j < data.Memories.length; j++) {
                        ...
                        if (j >= 3) {
                            $('#memory_working_page').append('<div class="memory_working_page" id="label' + j + '">' +
                                ...
                                '<a href="#" no="' + j + '" id="nom' + j + '" style="padding-left:65%;" hidden="hidden"><i class="fas fa-trash-alt"></i></a>' +
                                '<div style="padding-left:140px;padding-right:120px;">' +
...
dropDownTestType = function () {
    ...
    $("#TestTypeName").kendoComboBox({
        ...
        select: function (e) {
            ...
            viewModel.set('TestTypeCode', e.item.context.innerHTML);
        }
    });
}
...
function btnAnswerLayout(dataLayout) {
    ...
    var no = count + 1;
    $('#addForm').append('<div class="addFormAnswer" id="labels' + count + '">' +
                                    '<label>Answer ' + no + '<span class="mandatory">*</span></label>' +
...
addWorking = function (dataWorking) {
    ...
    $('#memory_working_page').append('<div class="memory_working_page" id="label' + count + '">' +
                                '<label>Memory ' + no + '<span class="mandatory">*</span></label>' +
...
addAnswerWorking = function (dataAnswer) {
    ...
    $('#noms' + (count - 1)).attr('hidden', true);
    var no = count + 1;
    $('#answer_working_page').append('<div class="answer_working_page" id="labels' + count + '">' +
                                '<label>Answer ' + no + '</label>' +
                                '<a href="#" no="' + count + '" id="noms' + count + '" style="padding-left:65%;"><i class="fas fa-trash-alt"></i></a>' +
                                '<div style="padding-left:140px;padding-right:120px;">' +
...
AnswerMemoryAttr = function (checkLength, idAttr) {
    ...
    $('#noms' + ansLength).removeAttr('hidden');
...
clearField = function (count, idAttr) {
    if (viewModel.QnACode == '') {
        $('#noms' + count).on('click', function () {
            $('#labels' + count).remove();
            $('#noms' + (count - 1)).removeAttr('hidden');
